...
% mathtools: somente serão enumeradas as equações que forem citadas no texto.
% Comentar as próximas duas linhas caso não desejar este recurso.
...
\logotipo{./logos/UFSCar-sigla-preto}
...
% Comente as próximas cinco linhas caso não haja ilustrações.
\cleardoublepage
\begingroup
...
% da folha ou página.
% Comente as próximas cinco linhas caso não haja tabelas.
\cleardoublepage
\begingroup
\renewcommand*{\addvspace}[1]{} % Elimina o espaço entre capítulos
\listoftables
...
% cada item designado por seu nome específico, acompanhado do respectivo número
% da folha ou página.
% Comente as próximas cinco linhas caso não haja quadros.
\cleardoublepage
\begingroup
\renewcommand*{\addvspace}[1]{} % Elimina o espaço entre capítulos
\listofquadros
...
% colocar Fonte: Elaborada pelo autor.
% Se o autor for do sexo feminino colocar "Fonte: Elaborada pela autora".
...
% Comente o ambiente (linhas abaixo) a seguir caso fizer uso.
\begin{appendices}
...
% Comente a linha abaixo caso não faça uso do índice. 
\printindex

% Declaração de uso de IA
% A declaração de uso de Inteligência Artificial (IA) é uma exigência. 
% O MEC (Ministério da Educação) e o CNPq não proíbem o uso de IA.
% No entanto, esses orgãos exigem transparência total no seu uso. 
% É obrigatório declarar qual ferramenta foi usada, a versão e a finalidade 
% específica. No comando abaixo é feito um modelo de declaração para o uso 
% apenas de revisão ortográfica. Se a IA foi utilizada de outra forma deverá 
% ser redigido texto semelhante.

% Comente a linha abaixo caso não faça uso deste modelo.
\declaracaoIA{ChatGPT (Versão 5.5)}{ChatGPT}

% Descomente caso desejar escrever sua própria declaração.
%\chapter*{Declaração}
